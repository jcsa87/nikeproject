        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-12 footer-right text-center">
                ...
                <ul class="list-unstyled d-flex justify-content-center gap-3">
                    <li><a href="https://www.instagram.com/nike" target="_blank"><img src="<?= base_url('assets/img/social_media/icons8-instagram-50.png') ?>" alt="Instagram" height="30"></a></li>
                    <li><a href="https://www.facebook.com/nike" target="_blank"><img src="<?= base_url('assets/img/social_media/icons8-facebook-50.png') ?>" alt="Facebook" height="30"></a></li>
                    <li><a href="https://www.twitter.com/nike" target="_blank"><img src="<?= base_url('assets/img/social_media/icons8-twitter-50.png') ?>" alt="Twitter" height="30"></a></li>
                </ul>
            </div>
        </div>
    </div>
